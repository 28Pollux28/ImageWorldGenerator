...
public enum BiomeColors{
    ...
    Small_End_Island(0x7070FF,BiomeKeys.SMALL_END_ISLANDS),
    End_Midlands(0x6060FF,BiomeKeys.END_MIDLANDS),
    End_HighLands(0x5050FF,BiomeKeys.END_HIGHLANDS),
    End_Barrens(0x9090FF,BiomeKeys.END_BARRENS),
