    ...
    public void segmentImage(String imageType){
        ...
        for(int i = 0; i< hCount; i++){
            ...
            for(int j = 0; j< wCount; j++){
                ...
                IImageLine lint;
                BufferedImage image = new BufferedImage(minWidth, minHeight,BufferedImage.TYPE_INT_RGB);
                int r =hProgress;
                while (r< hProgress+minHeight) {
                    ...
                    for (int ii = wProgress; ii < wProgress+minWidth; ii++) {
                        int nextPixel = 0;
                        if(channels ==4){
                            nextPixel = ImageLineHelper.getPixelARGB8(lint,ii)&0x00FFFFFF; /*|0xff000000;*/
                        }else if(channels==3){
